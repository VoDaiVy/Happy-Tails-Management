...
// Image diagnosis: open to guests (1 free scan enforced on frontend) and authenticated users
router.post('/diagnose', optionalAuth, upload.single('image'), diagnoseImage);  // POST /api/ai/diagnose
