...
import { PawPrint, Sparkles, Heart, Activity, Music, VolumeX, ArrowRight, Star, Play, CheckCircle } from 'lucide-react';
import Navbar from '../components/layout/Navbar';
import Footer from '../components/layout/Footer';

// --- SỬA LỖI Ở ĐÂY: Import trực tiếp từ 'react-player' ---
    ...
    return (
        <div className="bg-[#FDFBF7] min-h-screen font-sans text-[#2D3436] selection:bg-[#D97853] selection:text-white overflow-x-hidden">
            ...
            <div className="hidden">
                <ReactPlayer 
                    url='https://youtu.be/HCNqImHzMdk?si=mCUVett7RCujMrGc' // Link nhạc YouTube của bạn
                    playing={isPlaying}
                    loop={true}
