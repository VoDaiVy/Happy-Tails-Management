...
const ALL_SERVICES = [
  // AI Health
  {
    ...
    priceNum: 0,
    description:
      "Upload a pet photo and get an instant AI-powered preliminary health diagnosis.",
    tag: "ai-health",
    tagColor: "#7FB069",
  ...
  // Boarding
  {
    ...
    priceNum: 10,
    description:
      "Cozy, private suites designed for a peaceful and relaxing stay.",
    tag: "boarding",
    tagColor: "#7FB069",
    icon: <Bed size={18} />,
    image: "/standard.webp",
  },
  {
    ...
    priceNum: 25,
    description:
      "Spacious luxury suites with exclusive amenities and premium window view.",
    tag: "boarding",
    tagColor: "#E07A5F",
    icon: <Award size={18} />,
    image: "/viproom.jpg",
  },
  {
    ...
    priceNum: 4,
    description:
      "Premium kibble or wet food with customized feeding schedule and treats.",
    tag: "boarding",
    tagColor: "#7FB069",
...
const ServicePage = () => {
  ...
  const getSortedVeterinaryServices = () => {
    ...
    switch (sortBy) {
      ...
      case "Price (Low - High)":
        return sortedList.sort(
          (a, b) =>
            parseInt(a.priceRange.match(/\d+/)[0]) -
            parseInt(b.priceRange.match(/\d+/)[0]),
        );
      case "Price (High - Low)":
        return sortedList.sort(
          (a, b) =>
  ...
  const getCatColor = (cat) => {
    ...
    if (cat === "Spa & Grooming")
      return { bg: "#E07A5F/10", text: "#E07A5F", border: "#E07A5F/30" };
    if (cat === "Veterinary")
      return { bg: "#E07A5F/10", text: "#E07A5F", border: "#E07A5F/30" };
    if (cat === "Boarding")
      return { bg: "#1F2A37/10", text: "#1F2A37", border: "#1F2A37/30" };
    return { bg: "#7FB069/10", text: "#7FB069", border: "#7FB069/30" };
  };
  ...
  return (
    <div className="bg-[#F5F1EB] min-h-screen font-sans text-[#1F2A37] selection:bg-[#E07A5F] selection:text-white overflow-x-hidden">
      ...
      <main className="w-full mx-auto px-6 md:px-12 lg:px-[5%] pt-28 pb-20">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {(activeSearchQuery ||
                    ...
                    <p className="text-[13px] text-[#1F2A37]/50 font-medium flex items-center gap-1.5 flex-wrap">
                      ...
                      {activeCategory !== "All Categories" && (
                        <span className="font-bold text-[#1F2A37]/70">
                          {activeCategory}
                        </span>
                      )}
                      {activeCategory !== "All Categories" &&
        ...
        <div
          className={`flex flex-col w-full transition-all duration-500 ${isSearchMode ? "hidden" : ""}`}
        >
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="pr-2">
                ...
                <p className="text-[#1F2A37]/70 mb-10 text-[14px] md:text-[15px] leading-relaxed max-w-[95%]">
                  Experience the future of pet wellness. Our state-of-the-art AI
                  technology helps identify potential health concerns before
                  they become serious. Upload an image, and let our system
          ...
          <div
            id="veterinary"
            className={`w-[100vw] relative left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] bg-[#FFF5F2] py-10 overflow-hidden ${sortBy === "Name (A - Z)" ? "order-4 mt-4 mb-6" : sortBy === "Name (Z - A)" ? "order-1 mt-2 mb-6" : "order-3 mt-6 mb-6"}`}
          >
            {/* Subtle Paw Pattern */}
              ...
              >
                ...
                <div className="w-full md:w-[52%] flex flex-col justify-center py-2 lg:py-6">
                  ...
                  <p className="text-[#1F2A37]/70 text-[14px] md:text-[15px] leading-relaxed mb-8 max-w-[95%]">
                    ...
                    health. Our hospital is equipped with the latest diagnostic
                    technology to provide the highest standard of medical care
          ...
          <section
            id="spa-grooming"
            className={`relative z-10 w-full max-w-[1100px] mx-auto px-6 xl:px-4 ${sortBy === "Name (A - Z)" ? "order-3 mt-6 mb-6" : sortBy === "Name (Z - A)" ? "order-2 mt-6 mb-6" : "order-4 mt-6 mb-6"}`}
          >
          ...
          <section
            id="boarding"
            className={`relative z-10 w-[100vw] left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] bg-[#0F172A] pt-12 pb-16 px-6 md:px-8 ${sortBy === "Name (A - Z)" ? "order-2 mt-6" : sortBy === "Name (Z - A)" ? "order-3 mt-4" : "order-5 mt-6"}`}
          >
                ...
                <div className="bg-[#1E293B] group rounded-[24px] overflow-hidden border border-white/5 hover:border-[#7FB069]/30 hover:-translate-y-2 hover:shadow-[0_15px_40px_rgba(127,176,105,0.15)] transition-all duration-500 relative flex flex-col">
                  ...
                  <div className="p-5 flex-grow flex flex-col relative z-10 -mt-6">
                    ...
                    <p className="text-white/50 text-[12px] mb-6 flex-grow leading-relaxed">
                      Cozy, private suites designed for a peaceful and relaxing
                      stay. Perfect for a short getaway.
                    </p>
                  ...
                  <div className="flex gap-4 items-start md:items-center">
                    ...
                    <div>
                      ...
                      <p className="text-white/50 text-[12px] tracking-wide">
                        Premium kibble or wet food • Customized feeding schedule
